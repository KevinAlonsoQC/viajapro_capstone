    ...
    if (this.form.valid) {
      ...
      try {
        ...
        if (this.form.value.img_vehiculo) {
          ...
          const imagePath = `vehiculo/${Date.now()}`;
        ...
        await this.firebaseSvc.addDocument('vehiculo', nuevoVehiculo);
        ...
        this.utilsSvc.routerLink('/main/administrador/admin/conductores/vehiculos'); // Cambia esta ruta si es necesario
